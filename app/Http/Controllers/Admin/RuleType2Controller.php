...
class RuleType2Controller extends Controller
{
    ...
    {
        return view('admin.knowledge.rulesType2.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.knowledge.rulesType2.create', compact('facts'), compact('factsTypeComment'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.knowledge.rulesType2.edit', [
            'knowledge' => $knowledge,
