...
class RuleType1Controller extends Controller
{
    ...
    {
        return view('admin.knowledge.rulesType1.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.knowledge.rulesType1.create', compact('criteria'), compact('facts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.knowledge.rulesType1.edit', [
            'knowledge' => $knowledge,
            'criteria' => $criteria,
            'facts' => $facts,
        ]);
