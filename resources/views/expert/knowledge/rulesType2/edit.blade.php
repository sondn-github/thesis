...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <form action="{{route('expert.rulesType2.update', $knowledge->id)}}" class="form-horizontal" role="form"
                      method="post">
                    @csrf
                    @method('PUT')
                                                    ...
                                                    <select class="form-control" id="fact" name="facts[]" required>
                                                        ...
                                                        @foreach($factsTypeComment as $fact)
                                                            <option value="{{$fact->code}}"
                                                                    @if($premise[0] == $fact->code) selected @endif>{{$fact->code}}
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" id="conclusion" name="conclusion" required>
                                            ...
                                            @foreach($facts as $fact)
                                                <option value="{{$fact->code}}"
                                                        @if($knowledge->conclusion == $fact->code) selected @endif>{{$fact->code}}
                                                    - {{$fact->description}}</option>
                                            @endforeach
                                        </select>
                                    </div>
