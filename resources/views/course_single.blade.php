...
{{--                    </ul>--}}
                    ...
                    <p>
                        <a href="@if(isset($course->link)) {{$course->link}} @elseif(isset($course->lesson[0]->id)) {{route('display-lesson', $course->lesson[0]->id)}} @else # @endif" class="btn btn-primary rounded-0 btn-lg px-5">{{__('course.getStarted')}}</a>
