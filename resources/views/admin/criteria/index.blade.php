                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form action="{{route('admin.criteria.changing-type')}}" method="get">
                            ...
                            <input type="hidden" name="is_pfr" id="inlineRadio1" value="1">
{{--                            <div class="form-group">--}}
        ...
        var table = $('#criteriaTable').DataTable({
            ...
            columns: [
                ...
                {data: 'action', "searchable": false,
                    render: function (data, type, row, meta) {
                        return '<a href="/admin/criteria/' + row.id + '" class="btn btn-info btn-info-criteria" data-id="' + row.id + '" data-toggle="modal" data-target="#criteriaModal" onclick="showInfoModal(this)"><i class="fa fa-info-circle"></i></a>'
                        + '<a href="/admin/criteria/' + row.id + '/edit" class="btn btn-warning margin-r-5"><i class="fa fa-edit"></i></a>';
                    }
                },
