...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <a href="{{route('admin.rulesType2.create')}}" class="btn btn-primary mb-3">{{__('knowledge.new')}}</a>
        ...
        @section('js')
            <script>
                ...
                var table = $('#knowledgeTable').DataTable({
                    ...
                    order: [[1, 'asc']],
                    ajax: {
                        url: '{{route('admin.datatables.knowledge.rulesType2')}}',
                    },
                    columns: [
                        {
                            data: 'id',
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return '<a href="/admin/rulesType2/' + row.id + '/edit " class="btn btn-warning margin-r-5"><i class="fa fa-edit"></i></a>';
                            }
                        },
                    ],
                });
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            '{{__('knowledge.confirm')}}': function () {
                                $.ajax({
                                    type: "GET",
                                    url: '{{route('admin.ruleType2.changing-status')}}',
                                    dataType: "json",
                                    data: {
                                        id: id,
                                        status: value ? 1 : 0
