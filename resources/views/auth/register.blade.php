                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}" aria-label="{{ __('layouts/header.register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 col-form-label text-md-right required">{{ __('register.name') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label text-md-right required">{{ __('register.email') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-form-label text-md-right required">{{ __('register.password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right required">{{ __('register.re-password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="role" class="col-md-4 col-form-label text-md-right required">Vai trò</label>
