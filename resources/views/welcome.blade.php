                        ...
                        @foreach($popularLessons as $popularLesson)
                            <div class="course-1-item">
                                <figure class="thumnail">
                                    <a href="course-single.html"><img src="{{asset($popularLesson->thumbnail)}}" alt="Image" class="img-fluid"></a>
                                ...
                                <div class="course-1-content pb-4">
                                    ...
                                    <p><a href="{{route('lesson-single', $popularLesson->id)}}" class="btn btn-primary rounded-0 px-4">Enroll In This Course</a></p>
                                </div>
                            </div>
                        @endforeach
