            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="text-black">{{__('welcome.news')}}</h2>
                        ...
                        <div class="col-lg-6">
                            <div class="post-entry-big">
                                ...
                                <div class="post-content">
                                    ...
                                    <h3 class="post-heading"><a href="{{route('posts.show', $posts[0]->id)}}">{{$posts[0]->title}}</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            @foreach($posts->slice(1, 3) as $post)
                                <div class="post-entry-big horizontal d-flex mb-4">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h3 class="post-heading"><a href="{{route('posts.show', $post->id)}}">{{$post->title}}</a></h3>
                                    </div>
                                </div>
                            @endforeach
{{--                            <div class="post-entry-big horizontal d-flex mb-4">--}}
{{--                                <a href="#" class="img-link mr-4"><img src="{{asset('images/blog_1.jpg')}}" alt="Image" class="img-fluid"></a>--}}
{{--                                <div class="post-content">--}}
{{--                                    <div class="post-meta">--}}
...
{{--                            </div>--}}
{{--                            <div class="post-entry-big horizontal d-flex mb-4">--}}
{{--                                <a href="#" class="img-link mr-4"><img src="{{asset('images/blog_2.jpg')}}" alt="Image" class="img-fluid"></a>--}}
{{--                                <div class="post-content">--}}
{{--                                    <div class="post-meta">--}}
{{--                                        <a href="#">June 6, 2019</a>--}}
{{--                                        <span class="mx-1">/</span>--}}
